...
api_router.include_router(checklist_auto_endpoints.router, prefix='/checklist', tags=['checklist_auto_endpoints'])
# api_router.include_router(checklist_cam_endpoints.router, prefix='/checklist', tags=['checklist_cam_endpoints'])
# api_router.include_router(checklist_auto_endpoints.router, prefix='/checklist', tags=['checklist_auto_endpoints'])
